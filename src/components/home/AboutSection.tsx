...
const methodology = [
  {
    ...
    icon: Target,
    title: "Diagnóstico",
    description: "Mapeamos o problema real com análise rigorosa — não o sintoma.",
  },
  {
    step: "02",
    icon: Lightbulb,
    title: "Solução",
    description: "Desenhamos a arquitetura específica para seu contexto e dados.",
  },
  {
    step: "03",
    icon: Wrench,
    title: "Implementação",
    description: "Desenvolvemos e colocamos em produção com entregas incrementais.",
  },
  {
    step: "04",
    icon: Users,
    title: "Transferência",
    description: "Capacitamos sua equipe para sustentar e evoluir o resultado.",
  },
];
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground">
            ...
            <span className="gradient-text-purple">em 4 etapas</span>
          </h2>
          <p className="mt-6 text-muted-foreground max-w-3xl mx-auto text-lg leading-relaxed">
            Não entregamos apenas relatórios — implementamos soluções completas
